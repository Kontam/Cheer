...
const appConst = {
  ...
  IPC_CLOSE_WINDOW: 'IPC_CLOSE_WINDOW',
  ...
  IPC_SLACK_EMOJI_LIST: 'IPC_SLACK_EMOJI_LIST',
  IPC_SLACK_CHANNEL_LIST: 'IPC_SLACK_CHANNEL_LIST',
  IPC_SLACK_CHANNEL_INFO: 'IPC_SLACK_CHANNEL_INFO',
  IPC_SLACK_USER_PROFILE: 'IPC_SLACK_USER_PROFILE',
  IPC_SLACK_USER_INFO: 'IPC_SLACK_USER_INFO',
  IPC_SLACK_POST_MESSAGE: 'IPC_SLACK_POST_MESSAGE',
  IPC_SLACK_CONVERSATIONS_HISTORY: 'IPC_SLACK_CONVERSATIONS_HISTORY',
  // Window操作系
